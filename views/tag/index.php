...
$this->title = 'Tag Number Management';
...
<div class="header report-attr">
  <span class="title"> <?= $this->title ?> </span>
	<?= Html::a("New Tag", ["create"], ["id"=>"create", "class"=>"btn primary"]) ?>
</div>
...
Pjax::begin([
  ...
  'formSelector' => '.gridview-filter-form, #tag-form',
  'timeout' => 0,
...
<?= GridView::widget([
  ...
  'summary' => '<div class="pull-left">Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one {item} other {item}}</div> <span class="loader"></span>',
]);
