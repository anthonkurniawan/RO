...
function authView(name, type){    console.log(name, type);
  ...
  $('#auth-item-form').load('./authTest/auth/view/'+ encodeURIComponent(name) + '/'+ type, function(data){
    $(this).html(data);
  });
...
function formatError(data){
  ...
  //add class errors
  $.each($('#form-auth').find('.required :input'), function(i, item){
