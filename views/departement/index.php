...
$this->title = 'Departement Management';;
...
<div class="header report-attr">
  ...
  <?= Html::a("New Dept.", ["create"], ["id"=>"create", "class"=>"btn primary"]) ?>
</div>
...
Pjax::begin([
  ...
  'formSelector' => '.gridview-filter-form, #dept-form',
  'timeout' => 0,
...
<?= GridView::widget([
  ...
  'summary' => '<div class="pull-left">Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one {item} other {Departement}}</div> <span class="loader"></span>',
]);
